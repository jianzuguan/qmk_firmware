...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_DEFAULT] = LAYOUT(
          ...
          KC_TAB, KC_Q, KC_W,    KC_E,    KC_R,    KC_T,  KC_DEL,                      TT_MOUSE,    KC_Y,     KC_U,    KC_I,   KC_O,    KC_P, KC_BSPC, 
         ...
         KC_LSFT, KC_Z, KC_X,    KC_C,    KC_V,    KC_B, KC_CAPS, KC_LGUI,    KC_RGUI,      NUM,    KC_N,     KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, 
                                 BASE, KC_LALT, KC_LCTL,  KC_SPC,     SYM,        NAV,   KC_SPC, KC_RCTL, TG_MOUSE, KC_RALT
    ),
    ...
    [_MOUSE] = LAYOUT(
        ...
        _______, _______, KC_WBAK, KC_WREF, KC_WFWD, KC_MUTE, _______, _______,    _______, _______, _______, KC_MUTE, _______, _______, _______, _______,
                                   _______, _______, KC_BTN1, KC_BTN3, _______,    _______, _______, _______, _______, _______
    ), 
